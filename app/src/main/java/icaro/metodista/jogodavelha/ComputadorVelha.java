...
public class ComputadorVelha extends AppCompatActivity {
    private boolean jogadorX=true;
    @Override
 protected void onCreate(Bundle savedInstanceState){
     super.onCreate(savedInstanceState);
     setContentView(R.layout.velha_computador);
 }
    public void selecionar(View view) {
        ...
        if(botao.getContentDescription() == null || "".equals(botao.getContentDescription())) {
            if(jogadorX) {
               ...
               //     ((ImageView) findViewById(R.id.ImageView05)).setContentDescription("O");
                 //   ((ImageView) findViewById(R.id.ImageView05)).setImageResource(R.drawable.o);
             //   }
    ...
    private void apresentarMensagem(String msg) {
        AlertDialog.Builder builder = new AlertDialog.Builder(ComputadorVelha.this);
